...
from modules.pattern_learning.controller import router as pattern_learning_router
...
api_router.include_router(potd_router)
...
api_router.include_router(pattern_learning_router)
